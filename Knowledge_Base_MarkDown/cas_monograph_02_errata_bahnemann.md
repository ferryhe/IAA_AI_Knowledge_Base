# CAS_Monograph_02_Errata-Bahnemann

## Page 1
# Distributions for Actuaries <br> Errata 
...
line 13: Replace $k=1,2, \ldots, 9$ with $k=0,1,2, \ldots, 9$
Page 170, line 12: Replace $f_{X}(x)=F_{X}^{\prime}(x)$ with $f_{X}(x)=F_{X}^{\prime}(x)>0$
line 14: Delete factor $(1+u)$ from both equations
line 17: Replace continuous with positive and continuous

Page 173, line 11 from bottom: Delete factor $\left(1-F_{X}(a)\right)$

Page 174, line 9: Replace claim-size variable $N$ with claim-count variable $N$
Example 6.6, line 3 from bottom: Replace $(\mu, \sigma)=(7.000,2.400)$ with $(\mu, \sigma)=(7.600,2.400)$
...
Problem 6.1(d): Replace $\gamma$ with $\psi$
